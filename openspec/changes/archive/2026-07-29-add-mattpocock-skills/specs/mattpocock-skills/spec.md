...
為了日後手動重新 vendor 時有明確依據，本變更 SHOULD 在 commit message 記錄 upstream repo URL 與擷取時間，或在 proposal.md / design.md 記錄對應路徑對應（已在 design.md Decision 1 與 spec 第一個 requirement 記錄）。

...
Define requirements for opencode configuration files managed in dotfiles, ensuring `opencode.json` and `package.json` are version-controlled and deployed via symlinks as the single source of truth.

# Spec: clipboard-ipad-compat

## Purpose

確保在 iPad + Blink Shell + SSH + tmux 環境下，tmux copy mode 與 neovim yank 操作均能正確將內容複製到系統剪貼簿，透過 OSC 52 escape sequence passthrough 機制實現跨裝置剪貼簿整合。
